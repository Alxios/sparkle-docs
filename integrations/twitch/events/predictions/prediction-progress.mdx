...
description: Cette évènement est déclenché lorsqu'une actions est effectuée sur une prédiction en cours.
---
...
Description des propriétés de l'event `channel.prediction.progress` :
